/** @file ap33772.hpp
 * 
 * @brief this module is a driver for the AP33772, a high performance USB-PD Sink Controller.
 *
 * @par
...
public:
    ...
    /**
     * @brief Checks if the power supply is compatible and fetches the PDO profile.
    */
    void begin(void);
    ...
    */
    void set_NTC(uint16_t TR25, uint16_t TR50, uint16_t TR75, uint16_t TR100); //see EVB user guide page 13 for more information
