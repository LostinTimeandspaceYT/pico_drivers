...
class TPS25750 {
  public:
     ...
     */
    static TPS25750 *get_instance(uint8_t address = TPS25750_SADDR_1, uint sda = I2C_DEFAULT_SDA,
     ...
     */
    template <size_t N> struct RegisterArray {
  ...
  private:
    ...
    bool read_ascii_string(uint8_t reg, char *buffer, size_t buffer_length, size_t register_length);
};
