#include <pico_drivers/usb_pd/stusb4500.hpp>
...
void STUSB4500::read() {
    ...
    for (int i = 0; i < NUM_OF_SECTORS; ++i) {
        ...
        write_byte_to_reg(FTP_CTRL_0, FTP_CUST_SECT | FTP_CUST_PWR | FTP_CUST_RST_N | FTP_CUST_REQ);
...
void STUSB4500::write(bool default_mode) {
    if (default_mode) {
        uint8_t def_sector_1[SIZE_OF_SECTOR] = {0x00, 0x00, 0xb0, 0xaa, 0x00, 0x45, 0x00, 0x00};
        uint8_t def_sector_2[SIZE_OF_SECTOR] = {0x10, 0x40, 0x9C, 0x1C, 0xFF, 0x01, 0x3C, 0xDF};
        uint8_t def_sector_3[SIZE_OF_SECTOR] = {0x02, 0x40, 0x0F, 0x00, 0x32, 0x00, 0xFC, 0xF1};
        uint8_t def_sector_4[SIZE_OF_SECTOR] = {0x00, 0x19, 0x56, 0xAF, 0xF5, 0x35, 0x5F, 0x00};
        uint8_t def_sector_5[SIZE_OF_SECTOR] = {0x00, 0x4B, 0x90, 0x21, 0x43, 0x00, 0x40, 0xFB};
